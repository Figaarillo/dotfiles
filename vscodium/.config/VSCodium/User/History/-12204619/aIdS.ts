...
import type IBaseRepository from '../interface/base.repository.interface'
import type IBaseEntityData from '@shared/domain/entities/interfaces/base-data.entity.interface'
