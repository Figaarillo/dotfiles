...
abstract class BaseEntity<Entity, PrimitiveData> extends ImmutableEntity<PrimitiveData> implements IBaseEntity<Entity, PrimitiveData> {
  ...
  equals: (other: IBaseEntity<Entity, PrimitiveData>) => false
