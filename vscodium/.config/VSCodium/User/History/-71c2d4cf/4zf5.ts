...
//     console.log("Persistiendo en MySQL...");
...
class PostgreSQLDatabse implements Database {
  persist(data: string): void {
    console.log("Persistiendo en PostgreSQL...");
    console.log("Data: ", data); 
  }
}

class SQLServerDatabse implements Database {
  persist(data: string): void {
    console.log("Persistiendo en SQLServer...");
    console.log("Data: ", data); 
  }
}
...
const logic = new Logic(new PostgreSQLDatabse());
logic.operation("some data");
