...
func mapData() {
	...
	fmt.Println(m["Superman"]) // El elemento no existe, asi que se esperaria que el valor sea nulo o se arroje un error, pero en realidad se devuelve 0, sin terminar de saber s 
