...
const newUser2 = creatorUseCase.execute(userPayload2)
const newUser3 = creatorUseCase.execute(userPayload3)
const newUser4 = creatorUseCase.execute(userPayload4)
